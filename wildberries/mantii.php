...
$url = "https://www.wildberries.ru/catalog/muzhchinam/mantii?pagesize=100&sort=sale&page=";

$file = curl_get_contents($url);
$doc = phpQuery::newDocument($file);


parce_it(2,$url,'wildberries-mantii','mantii',$p_link,$price_bf,$price_af,$img,$name,$p_desc,$start,$end,$p_group,$p_brand,$p_category);
