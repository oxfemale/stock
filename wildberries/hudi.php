...
$url = "https://www.wildberries.ru/catalog/muzhchinam/odezhda/hudi?pagesize=100&sort=sale&page=";

$file = curl_get_contents($url);
$doc = phpQuery::newDocument($file);


parce_it(3,$url,'wildberries-hudi','hudi',$p_link,$price_bf,$price_af,$img,$name,$p_desc,$start,$end,$p_group,$p_brand,$p_category);
